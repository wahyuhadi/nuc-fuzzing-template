### Improper Error Handling (baderror-fuzzing-b6dd662a7d0ae99505f95a1bc4689fdc309c43b82e714f14a7758da8eeecf315) found on api-v3.career.support

----
**Details**: **baderror-fuzzing-b6dd662a7d0ae99505f95a1bc4689fdc309c43b82e714f14a7758da8eeecf315** matched at api-v3.career.support

**Protocol**: HTTP

**Full URL**: https://api-v3.career.support/school/api/v1/candidate/invite/get?name&start_year&end_year=../../~`&page=1&student_number
...
**Request**
```http
GET /school/api/v1/candidate/invite/get?name&start_year&end_year=../../~\`&page=1&student_number HTTP/1.1
